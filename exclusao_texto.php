...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["pergunta_selecionada"])) {
        ...
        if ($indicePergunta >= 0 && $indicePergunta < count($perguntas)) {
            ...
            // Escrever o conteúdo atualizado de volta no arquivo "respostas_texto.txt"
            file_put_contents("respostas_texto.txt", $novoConteudo);
